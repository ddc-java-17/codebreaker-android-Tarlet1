...
public class RanksFragment extends Fragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    codebreakerViewModel.getGame()
        .observe(owner, (game) -> {
          // TODO: 3/18/2024 If we have both code length and games threshold, invoke rankingsViewModel.fetch(codelength, gamethreshold).
        });
    ...
    preferencesViewModel.getPreferredGamesThreshold()
        .observe(owner, (threshold) -> {
          // TODO: 3/18/2024 // TODO: 3/18/2024 If we have both code length and games threshold, invoke rankingsViewModel.fetch(codelength, gamethreshold).
        });
  }
