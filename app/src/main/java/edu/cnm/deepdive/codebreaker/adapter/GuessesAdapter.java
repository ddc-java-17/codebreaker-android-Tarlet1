...
public class GuessesAdapter extends ArrayAdapter<Guess> {
  ...
  public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    guess.getContent()
        .codePoints()
        .forEach((codePoint) -> {
          // TODO: 2/20/2024 Inflate item_guess_chars;
          //  set content description to color name corresponding to codepoint;
          //  set color filter (tint) to color value corresponding to codePoint;
          //  add inflated view to binding.guess.
        });
